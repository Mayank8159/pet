      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          ...
          >
            ...
            <p className={`mt-3 text-sm ${isDark ? "text-slate-300" : "text-slate-600"}`}>Theme Profile</p>
            <p className="mt-1 text-2xl font-semibold">Service Adaptive</p>
          </article>
          <article
            className={`rounded-2xl border p-4 ${
              isDark
          ...
          >
            ...
            <p className={`mt-3 text-sm ${isDark ? "text-slate-300" : "text-slate-600"}`}>Alert Routing</p>
          ...
          >
            ...
            <p className={`mt-3 text-sm ${isDark ? "text-slate-300" : "text-slate-600"}`}>Role Guard</p>
