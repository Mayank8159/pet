      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          ...
          >
            ...
            <p className={`mt-3 text-sm ${isDark ? "text-slate-300" : "text-slate-600"}`}>Today Revenue</p>
          ...
          >
            ...
            <p className={`mt-3 text-sm ${isDark ? "text-slate-300" : "text-slate-600"}`}>Bills Closed</p>
